...
[11. Объясните разницу между <script>, <script async> и <script defer>?](html/html.md#11-объясните-разницу-script-и-defer)

[12. Почему хорошей практикой считается располагать <link> для подключения CSS между <head></head>, а <script> для подключения JS ставить перед </body>? Знаете ли вы исключения?](html/html.md#12-почему-хорошей-тон)
