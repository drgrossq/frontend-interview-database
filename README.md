...
[12. Почему хорошей практикой считается располагать <link> для подключения CSS между <head></head>, а <script> для подключения JS ставить перед </body>? Знаете ли вы исключения?](html/html.md#12-почему-хорошей-практикой-считается-располагать--для-подключения-css-между--а--для-подключения-js-ставить-перед--знаете-ли-вы-исключения)
